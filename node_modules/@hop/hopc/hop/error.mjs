/* generated file (node_modules/hopc/hop/Makefile), do not edit (04 June 2024) */
/*=====================================================================*/
/*    serrano/prgm/project/hop/hop/node_modules/hopc/hop/error.mjs     */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Sat Sep 16 14:11:38 2023                          */
/*    Last change :  Sun Jun  2 09:02:55 2024 (serrano)                */
...
function locToLnumCol(fname, location) {
   ...
   } else if (fname && fname.match(/^string:\/\//)) {
      return lnumCol(fname.substring(9, location));
   } else {
...
function lineColToLnumCol(fname, lnum, col) {
   ...
   if (existsSync(fname)) {
      ...
      return lnumCol(fname.substring(9, lnum));
   } else {
      return { beg: -1, end: -1, lnum: 0, col: 0, line: "" };
   }
}
